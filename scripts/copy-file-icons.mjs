...
const CURATED_EXTENSIONS = [
	...
	"md", "markdown", "mdx",
	// Config / data
	"yaml", "yml", "toml", "ini", "cfg", "conf", "env", "lock",
	// Shell / scripts
	"sh", "bash", "zsh", "fish", "ps1", "bat", "cmd",
	// Languages
	"py", "ipynb", "java", "class", "jar", "kt", "kts", "go", "mod", "sum", "rs", "c", "h", "cpp", "cc", "cxx", "hpp",
	"cs", "php", "rb", "swift", "m", "mm", "dart", "flutter",
	// Frameworks / markup
	"vue", "svelte", "astro", "sql", "prisma", "graphql", "gql", "proto", "thrift", "wasm",
	// Docker / CI
	"dockerfile",
	// Media
	"svg", "png", "jpg", "jpeg", "gif", "webp", "ico", "bmp", "tiff", "mp3", "mp4", "mov", "avi", "mkv", "wav",
	"pdf", "zip", "tar", "gz", "rar", "7z",
	// Office / other
	"log", "csv", "xlsx", "xls", "docx", "doc", "pptx", "ppt", "xml", "txt",
];
...
const CURATED_FILE_NAMES = [
	...
	"eslint.config.js", "eslint.config.ts", ".eslintrc.json", ".eslintrc.js", ".eslintrc",
	".prettierrc", ".prettierrc.json", ".prettierrc.js", ".babelrc", ".babelrc.json",
	".gitignore", ".gitattributes", ".editorconfig", ".env", ".env.example", ".env.local",
	"README.md", "LICENSE", "CHANGELOG.md", "CONTRIBUTING.md",
	"Makefile", "CMakeLists.txt", "Dockerfile", "docker-compose.yml", "docker-compose.yaml",
	"Jenkinsfile", ".nvmrc", ".node-version",
	"playwright.config.ts", "jest.config.js", "vitest.config.ts", "cypress.config.ts",
...
const CURATED_FOLDER_NAMES = [
	"src", "source", "dist", "build", "out", "output", "public", "assets",
	"images", "img", "icons", "fonts", "styles", "style", "css", "scss", "sass", "less",
	"scripts", "js", "ts", "components", "component", "views", "pages", "page",
	"layouts", "layout", "routes", "route", "api", "apis", "services", "service",
	"utils", "util", "helpers", "helper", "hooks", "hook", "context", "contexts",
	"store", "stores", "state", "states", "redux", "models", "model", "types", "type",
	"interfaces", "interface", "constants", "constant", "config", "configs", "configuration",
	"settings", "env", "environments", "environment",
	"tests", "test", "testing", "__tests__", "spec", "specs", "e2e", "coverage",
	"docs", "doc", "documentation", "examples", "example", "demo", "demos", "samples", "sample",
	"packages", "package", "node_modules", "modules", "lib", "libs", "vendor", "vendors",
	"bin", "tools", "tool", "ci", ".github", ".git", ".vscode", ".idea",
	"tmp", "temp", "cache", "logs", "backup", "backups", "archive", "archives",
	"release", "releases", "deploy", "deployment", "kubernetes", "k8s", "docker",
	"infra", "infrastructure", "terraform", "ansible", "vagrant",
	"secrets", "secret", "credentials", "certs", "certificates", "ssl", "keys", "key", "private",
];
