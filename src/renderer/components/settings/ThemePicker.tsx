...
export function ThemePicker() {
	...
	return (
		<div className="flex items-center justify-between gap-4 rounded-md border border-hairline px-3 py-2.5">
			...
			<div className="flex shrink-0 items-center gap-1.5" aria-label={t("settings.themeTone")}>
				...
				<Switch
					...
					aria-label={tone === "dark" ? t("settings.themeToneLight") : t("settings.themeToneDark")}
				/>
