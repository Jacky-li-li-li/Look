													...
													<div className="flex items-center gap-2 text-[13px] font-medium">
														...
														{p.hasKey ? (
															...
															<Badge
																...
																title={
																	p.envLabel
																		? `Detected from $${p.envLabel} in environment`
                                ...
                                it failed, neutral otherwise. */}
														{ts === "ok" && (
															<span
																...
																title="Last saved key passed live self-test"
															>
														...
														{ts === "error" && (
															<span
																className="inline-flex items-center gap-1 rounded-full bg-rose-500/10 px-1.5 py-0.5 text-[10px] font-medium text-rose-600 dark:text-rose-400"
																title="Last saved key failed live self-test"
															>
														...
														{ts === "skipped" && (
															<span
																...
																title="Saved without self-test (no probe configured for this provider)"
															>
																Untested
															</span>
														)}
