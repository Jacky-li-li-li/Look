...
import { cancelAutoInstall, checkForUpdates, downloadUpdate, installUpdate } from "../../system/app-updater.js";
...
export const updaterRouter: IpcRouter = (_ctx, register) => {
	...
	register("update:cancel-install", async () => cancelAutoInstall());
};
